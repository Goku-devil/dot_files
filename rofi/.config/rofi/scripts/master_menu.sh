...
while true; do
  ...
  # ==========================================
    ...
    case "$CHOICE" in
    *YouTube*)
      "zen-browser 'https://youtube.com'"
      exit 0
      ;;
    *Gemini*)
      open_webapp "https://gemini.google.com"
      exit 0
      ;;
    *Gmail*)
      open_webapp "https://mail.google.com"
      exit 0
      ;;
    *WhatsApp*)
      open_webapp "https://web.whatsapp.com"
      exit 0
      ;;
    *GitHub*)
      open_webapp "https://github.com"
      exit 0
      ;;
    *LinkedIn*)
      open_webapp "https://linkedin.com"
      exit 0
      ;;
    *Crunchyroll*)
      open_webapp "https://crunchyroll.com"
      exit 0
      ;;
    *) MENU_STATE="main" ;;
    esac
  ...
  # ==========================================
    ...
    case "$CFG_CHOICE" in
    *Hyprland*)
      kitty nvim ~/.dotfiles/hyprland/.config/hypr/modules/keybinds.lua
      exit 0
      ;;
    *Rofi*)
      ...
      ;;
    *Neovim*)
      kitty nvim ~/.config/nvim/init.lua
      exit 0
      ;;
    *Waybar*)
      ...
      ;;
    *Network*)
      kitty nvim ~/.config/rofi/scripts/network_manager.sh
      exit 0
      ;;
    *) MENU_STATE="main" ;;
    esac
